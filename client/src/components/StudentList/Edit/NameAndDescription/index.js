        ...
        <div className={styles.wrap}>
          ...
          <div className={styles.scoreDetail}>
            <div className={styles.dropdownStyle}>
              <Dropdown value={term} setValue={setTerm} options={termOptions} />
            </div>
            ...
            <div className={styles.currentClass}>
              <div className={cn("button", styles.typeClass)}>AVG:</div>
              <div className={styles.className}>{student.avg}</div>
            </div>
            <div className={styles.currentClass}>
              <div className={cn("button", styles.typeClass)}>Type:</div>
              <div className={styles.className}>{student.type}</div>
            </div>
          </div>
        </div>
